...
* 아이템 53. [가변인수는 신중히 사용하라](chapter-08/item-53.md)
* 아이템 54. [null이 아닌, 빈 컬렉션이나 배열을 반환하라](chapter-08/item-54.md)
* 아이템 55. [옵셔널 반환은 신중히 하라](chapter-08/item-55.md)
* 아이템 56. [공개된 API 요소에는 항상 문서화 주석을 작성하라](chapter-08/item-56.md)
